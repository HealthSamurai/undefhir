...
var G__63823 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__63823__$1 = (((G__63823 == null))?null:cljs.core.iterate((function (loc){
...
var G__63823__$2 = (((G__63823__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__63823__$1));
var G__63823__$3 = (((G__63823__$2 == null))?null:cljs.core.last(G__63823__$2));
if((G__63823__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__63823__$3);
}
} else {
return zloc;
}
...
var G__63850 = rewrite_clj.zip.move.right(v);
var G__63851 = rewrite_clj.zip.move.up(v);
loc = G__63850;
parent = G__63851;
continue;
} else {
var G__63852 = rewrite_clj.zip.move.right(v0);
var G__63853 = parent;
loc = G__63852;
parent = G__63853;
continue;
...
var G__63854 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__63855 = rewrite_clj.zip.move.up(v);
loc = G__63854;
parent = G__63855;
continue;
} else {
var G__63856 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__63857 = parent;
loc = G__63856;
parent = G__63857;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__63840 = zloc;
var G__63840__$1 = (((G__63840 == null))?null:rewrite_clj.zip.move.down(G__63840));
var G__63840__$2 = (((G__63840__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__63840__$1,k));
if((G__63840__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__63840__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__63841 = rewrite_clj.zip.move.down(zloc);
var G__63841__$1 = (((G__63841 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__63841));
if((G__63841__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__63841__$1);
}
})(),k);
}
});
