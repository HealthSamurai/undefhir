...
var G__55090 = (i__4790__auto___55088 + (1));
i__4790__auto___55088 = G__55090;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq55045){
var G__55046 = cljs.core.first(seq55045);
var seq55045__$1 = cljs.core.next(seq55045);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55046,seq55045__$1);
}));
...
return cljs.core.some((function (p1__55061_SHARP_){
return (p1__55061_SHARP_ === object);
}),history);
});
