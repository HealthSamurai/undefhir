...
return [(function (){var pred__65784 = cljs.core.instance_QMARK_;
var expr__65785 = reactive_val;
if(cljs.core.truth_((pred__65784.cljs$core$IFn$_invoke$arity$2 ? pred__65784.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__65785) : pred__65784.call(null,reagent.ratom.RAtom,expr__65785)))){
return "ra";
} else {
if(cljs.core.truth_((pred__65784.cljs$core$IFn$_invoke$arity$2 ? pred__65784.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__65785) : pred__65784.call(null,reagent.ratom.RCursor,expr__65785)))){
return "rc";
} else {
if(cljs.core.truth_((pred__65784.cljs$core$IFn$_invoke$arity$2 ? pred__65784.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__65785) : pred__65784.call(null,reagent.ratom.Reaction,expr__65785)))){
return "rx";
} else {
if(cljs.core.truth_((pred__65784.cljs$core$IFn$_invoke$arity$2 ? pred__65784.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__65785) : pred__65784.call(null,reagent.ratom.Track,expr__65785)))){
return "tr";
} else {
return "other";
}
