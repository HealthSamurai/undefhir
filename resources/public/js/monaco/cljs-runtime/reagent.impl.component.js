...
if((i < len)){
var k = (ks[i]);
var G__65435 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__65436 = (i + (1));
m = G__65435;
i = G__65436;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__65265 = p.children;
return module$node_modules$react$index.Children.toArray(G__65265);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__65277 = c;
var G__65277__$1 = (((G__65277 == null))?null:G__65277.prototype);
if((G__65277__$1 == null)){
return null;
} else {
return G__65277__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__65279 = c;
var G__65279__$1 = (((G__65279 == null))?null:G__65279.prototype);
if((G__65279__$1 == null)){
return null;
} else {
return G__65279__$1.render;
}
})() == null)))));
});
...
var G__65287 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__65287) : reagent.impl.component.as_element.call(null,G__65287));
};
...
while (G__65445__i < G__65445__a.length) {G__65445__a[G__65445__i] = arguments[G__65445__i + 0]; ++G__65445__i;}
  args = new cljs.core.IndexedSeq(G__65445__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__65288 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__65289 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__65289);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__65288);
}});
...
var c = this;
var G__65311_65458 = goog.object.get(c,"cljsRatom");
if((G__65311_65458 == null)){
} else {
reagent.ratom.dispose_BANG_(G__65311_65458);
}
...
var renders_65467 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_65468 = cljs.core.first(cljs.core.vals(renders_65467));
...
if((cljs.core.count(renders_65467) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_65467))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_65468)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_65468], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__65324 = o;
var G__65325_65473 = G__65324;
var G__65326_65474 = cljs.core.name(k);
var G__65327_65475 = v;
goog.object.set(G__65325_65473,G__65326_65474,G__65327_65475);
...
var G__65361_65482 = cmp.prototype;
var G__65362_65483 = module$node_modules$react$index.Component.prototype;
var G__65363_65484 = methods$;
goog.object.extend(G__65361_65482,G__65362_65483,G__65363_65484);
...
var name = (function (){var G__65376 = fiber;
var G__65376__$1 = (((G__65376 == null))?null:G__65376.type);
if((G__65376__$1 == null)){
return null;
} else {
return G__65376__$1.displayName;
}
})();
var parent = (function (){var G__65377 = fiber;
if((G__65377 == null)){
return null;
} else {
return G__65377.return;
}
})();
var path = (function (){var G__65378 = parent;
var G__65378__$1 = (((G__65378 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__65378) : reagent.impl.component.fiber_component_path.call(null,G__65378)));
if((G__65378__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65378__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__65382 = c;
if((G__65382 == null)){
return null;
} else {
return goog.object.get(G__65382,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__65384._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__65389 = c;
if((G__65389 == null)){
return null;
} else {
return goog.object.get(G__65389,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__65392 = c;
if((G__65392 == null)){
return null;
} else {
return G__65392._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__65394 = instance;
if((G__65394 == null)){
return null;
} else {
return goog.object.get(G__65394,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__65399 = instance;
if((G__65399 == null)){
return null;
} else {
return G__65399._currentElement;
}
}
})();
var name = (function (){var G__65401 = elem;
var G__65401__$1 = (((G__65401 == null))?null:G__65401.type);
if((G__65401__$1 == null)){
return null;
} else {
return G__65401__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__65409 = elem;
if((G__65409 == null)){
return null;
} else {
return goog.object.get(G__65409,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__65418._owner;
}
}
})();
var path = (function (){var G__65420 = owner;
var G__65420__$1 = (((G__65420 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__65420) : reagent.impl.component.component_path.call(null,G__65420)));
if((G__65420__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65420__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__65427 = c;
var G__65427__$1 = (((G__65427 == null))?null:G__65427.constructor);
if((G__65427__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__65427__$1);
}
}
})();
