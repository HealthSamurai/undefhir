...
var G__64398 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__64398;
continue;
} else {
var G__64399 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__64399;
continue;
}
} else {
var G__64402 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__64402;
continue;
}
}
...
var G__64379 = zloc;
var G__64380 = (function (){var G__64381 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__64382 = zloc;
var G__64382__$1 = (((G__64382 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__64382) : rewrite_clj.zip.node.call(null,G__64382)));
if((G__64382__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__64382__$1) : zprint.zutil.edn_STAR_.call(null,G__64382__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__64381) : rewrite_clj.zip.root.call(null,G__64381));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__64379,G__64380) : rewrite_clj.zip.replace.call(null,G__64379,G__64380));
});
/**
...
var G__64405 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__64405;
continue;
}
break;
...
var G__64408 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__64409 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__64408;
out = G__64409;
continue;
} else {
...
var G__64413 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__64414 = cljs.core.next(new_loc);
var G__64415 = replaced_loc;
nloc = G__64413;
new_loc = G__64414;
last_loc = G__64415;
continue;
...
return zprint.rewrite.sort_val((function (){var G__64388 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__64388) : rewrite_clj.zip.down.call(null,G__64388));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__64389_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__64389_SHARP_) : rewrite_clj.zip.tag.call(null,p1__64389_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__64389_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__64389_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
