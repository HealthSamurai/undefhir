...
var o55003 = temp__5733__auto__;
var temp__5733__auto____$1 = (o55003["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o55004 = temp__5733__auto____$1;
return (o55004["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40421__auto__ = f;
return (o__40421__auto__["toString"]).call(o__40421__auto__);
} else {
return "";
}
}catch (e55005){var _ = e55005;
return "";
}});
...
try{var o__40421__auto___55243 = t;
(o__40421__auto___55243["cljs$lang$ctorPrWriter"]).call(o__40421__auto___55243,t,writer);
}catch (e55007){var __55244 = e55007;
}
...
var char_code = (function (){var o__40421__auto__ = (new String(char$));
return (o__40421__auto__["charCodeAt"]).call(o__40421__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40421__auto__ = String;
return (o__40421__auto__["fromCharCode"]).call(o__40421__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__55021 = num_code;
switch (G__55021) {
case (1):
return (185);
...
var o__40421__auto__ = String;
return (o__40421__auto__["fromCharCode"]).call(o__40421__auto__,superscript_code);
});
/**
...
}catch (e55027){var _e__40465__auto__ = e55027;
return false;
}})())){
...
var vec__55028 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55028,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o55042 = temp__5733__auto__;
var temp__5733__auto____$1 = (o55042["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o55043 = temp__5733__auto____$1;
return (o55043["nameToPath"]);
} else {
return null;
}
} else {
...
var G__55267 = (i__4790__auto___55266 + (1));
i__4790__auto___55266 = G__55267;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__55050){
var vec__55051 = p__55050;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55051,(0),null);
...
var G__55278 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__55279 = cljs.core.butlast(remaining_tokens);
name_tokens = G__55278;
remaining_tokens = G__55279;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq55048){
var G__55049 = cljs.core.first(seq55048);
var seq55048__$1 = cljs.core.next(seq55048);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55049,seq55048__$1);
}));
...
var vec__55070 = cljs.core.split_with((function (p1__55068_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__55068_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55070,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55070,(1),null);
...
var vec__55078 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55078,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55078,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__55284 = cljs.core.rest(remaining_tokens);
var G__55285 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__55284;
name_tokens = G__55285;
continue;
} else {
...
var vec__55091 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55091,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55091,(1),null);
var vec__55094 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55094,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55094,(1),null);
var vec__55097 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55097,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55097,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55097,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55097,(3),null);
...
var vec__55107 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55107,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55107,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55107,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55107,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55107,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55107,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__55110 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55110,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55110,(1),null);
var vec__55113 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55113,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55113,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__55117 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__55117) : devtools.munging.parse_fn_info_deep.call(null,G__55117));
})()));
}
} else {
return fn_info;
...
var G__55302 = (arity + (1));
var G__55303 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__55130){
var vec__55131 = p__55130;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55131,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55131,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55144_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__55144_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55145_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__55145_SHARP_);
}),sorted_infos);
...
var args__4795__auto__ = [];
var len__4789__auto___55324 = arguments.length;
var i__4790__auto___55328 = (0);
while(true){
if((i__4790__auto___55328 < len__4789__auto___55324)){
args__4795__auto__.push((arguments[i__4790__auto___55328]));

var G__55329 = (i__4790__auto___55328 + (1));
i__4790__auto___55328 = G__55329;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__55148){
var vec__55149 = p__55148;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55149,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq55146){
var G__55147 = cljs.core.first(seq55146);
var seq55146__$1 = cljs.core.next(seq55146);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55147,seq55146__$1);
}));
...
var G__55153 = arg;
var G__55153__$1 = (((G__55153 instanceof cljs.core.Keyword))?G__55153.fqn:null);
switch (G__55153__$1) {
...
var map__55170 = options;
var map__55170__$1 = (((((!((map__55170 == null))))?(((((map__55170.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55170.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55170):map__55170);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55170__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55170__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55170__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55170__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__55171 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55171,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55171,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55171,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55171,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55171,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55171,(5),null);
...
var o__40421__auto__ = f;
return (o__40421__auto__["getBasis"]).call(o__40421__auto__);
});
/**
...
}catch (e55186){var _e__40465__auto__ = e55186;
...
var G__55356 = (obj[cljs.core.first(path)]);
var G__55357 = cljs.core.rest(path);
obj = G__55356;
path = G__55357;
continue;
} else {
...
var _STAR_ = (function (accum,p__55208){
var vec__55209 = p__55208;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55209,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55209,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__55221){
var vec__55222 = p__55221;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55222,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55222,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55222,(2),null);
...
var post_process = (function (p__55232){
var vec__55233 = p__55232;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55233,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55233,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55228_SHARP_){
return (obj[cljs.core.first(p1__55228_SHARP_)]);
}),sorted_matches);
