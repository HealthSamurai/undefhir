...
var len__4789__auto___55383 = arguments.length;
var i__4790__auto___55384 = (0);
while(true){
if((i__4790__auto___55384 < len__4789__auto___55383)){
args__4795__auto__.push((arguments[i__4790__auto___55384]));

var G__55385 = (i__4790__auto___55384 + (1));
i__4790__auto___55384 = G__55385;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq55304){
var G__55305 = cljs.core.first(seq55304);
var seq55304__$1 = cljs.core.next(seq55304);
var G__55306 = cljs.core.first(seq55304__$1);
var seq55304__$2 = cljs.core.next(seq55304__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55305,G__55306,seq55304__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__55334_SHARP_){
return (!((cljs.core.meta(p1__55334_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55343__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e55354){var _e__40465__auto__ = e55354;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e55358){var _e__40465__auto__ = e55358;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__55363 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__55364 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__55364);

try{var map__55366 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55366__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__55363);
}});
...
var temp__5733__auto___55431 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___55431)){
var managed_print_level_55432 = temp__5733__auto___55431;
var _STAR_print_level_STAR__orig_val__55372_55433 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__55373_55434 = managed_print_level_55432;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__55373_55434);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__55368_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__55368_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__55372_55433);
}} else {
job_fn();
}
