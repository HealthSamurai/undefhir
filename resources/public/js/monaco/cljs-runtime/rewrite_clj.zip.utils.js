...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__63625,k,f){
var vec__63632 = p__63625;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63632,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63632,(1),null);
var loc = vec__63632;
...
var G__63690 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__63690;
continue;
}
break;
...
var G__63695 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__63695;
continue;
} else {
return zloc__$1;
...
var G__63700 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__63700;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__63648){
var vec__63649 = p__63648;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63649,(0),null);
var map__63652 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63649,(1),null);
...
var path = map__63652__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63652__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__63649;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__63660){
var vec__63661 = p__63660;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63661,(0),null);
var map__63664 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63661,(1),null);
...
var path = map__63664__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63664__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__63661;
if(cljs.core.seq(r)){
...
var vec__63669 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63669,(0),null);
var map__63672 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63669,(1),null);
...
var path = map__63672__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63672__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63672__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63672__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63672__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
