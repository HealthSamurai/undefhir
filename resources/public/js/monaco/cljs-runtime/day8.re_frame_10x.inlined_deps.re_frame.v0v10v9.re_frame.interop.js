...
return [(function (){var pred__60938 = cljs.core.instance_QMARK_;
var expr__60939 = reactive_val;
if(cljs.core.truth_((pred__60938.cljs$core$IFn$_invoke$arity$2 ? pred__60938.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RAtom,expr__60939) : pred__60938.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RAtom,expr__60939)))){
return "ra";
} else {
if(cljs.core.truth_((pred__60938.cljs$core$IFn$_invoke$arity$2 ? pred__60938.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RCursor,expr__60939) : pred__60938.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RCursor,expr__60939)))){
return "rc";
} else {
if(cljs.core.truth_((pred__60938.cljs$core$IFn$_invoke$arity$2 ? pred__60938.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Reaction,expr__60939) : pred__60938.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Reaction,expr__60939)))){
return "rx";
} else {
if(cljs.core.truth_((pred__60938.cljs$core$IFn$_invoke$arity$2 ? pred__60938.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Track,expr__60939) : pred__60938.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Track,expr__60939)))){
return "tr";
} else {
return "other";
}
