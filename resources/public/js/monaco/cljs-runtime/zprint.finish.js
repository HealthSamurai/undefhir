...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__62230_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__62230_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__62230_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__62231){
var vec__62232 = p__62231;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62232,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62232,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__62236,s,color,element,idx){
var map__62237 = p__62236;
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62237__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62237__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62237__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__62241 = (function (){var or__4185__auto__ = color;
...
var fexpr__62240 = (function (){var G__62242 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__62242) : style_map.call(null,G__62242));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__62246){
var vec__62248 = p__62246;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62248,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62248,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62248,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__62253){
var vec__62254 = p__62253;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62254,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62254,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62254,(2),null);
...
var G__62325 = cljs.core.next(ssv);
var G__62326 = (this_ssv == null);
var G__62327 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__62328 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__62325;
doing_nil_QMARK_ = G__62326;
last_elide = G__62327;
out = G__62328;
continue;
}
...
var vec__62261 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62261,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62261,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62261,(2),null);
...
var G__62330 = cljs.core.next(remaining_cvec);
var G__62331 = new_idx;
var G__62332 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__62330;
idx = G__62331;
out = G__62332;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__62269,cursor_vec){
var vec__62270 = p__62269;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62270,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62270,(1),null);
var focus_vec = vec__62270;
...
var vec__62273 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62273,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62273,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__62277){
var vec__62278 = p__62277;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62278,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62278,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__62286,existing_count){
var vec__62287 = p__62286;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62287,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62287,(1),null);
...
return cljs.core.filterv((function (p1__62282_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__62282_SHARP_))));
...
var vec__62298 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62298,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62298,(1),null);
var cvec_element = vec__62298;
if((cvec_element == null)){
var G__62346 = cljs.core.next(cvec_nl);
var G__62347 = (idx + (1));
var G__62348 = start;
var G__62349 = out;
cvec_nl = G__62346;
...
var G__62350 = cljs.core.next(cvec_nl);
var G__62351 = (idx + (1));
var G__62352 = idx;
var G__62353 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__62350;
idx = G__62351;
start = G__62352;
out = G__62353;
...
var G__62355 = cljs.core.next(cvec_nl);
var G__62356 = (idx + (1));
var G__62357 = (idx + (1));
var G__62358 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__62355;
idx = G__62356;
start = G__62357;
out = G__62358;
...
var G__62359 = cljs.core.next(cvec_nl);
var G__62360 = (idx + (1));
var G__62361 = idx;
var G__62362 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__62359;
idx = G__62360;
start = G__62361;
out = G__62362;
...
var G__62363 = cljs.core.next(cvec_nl);
var G__62364 = (idx + (1));
var G__62365 = start;
var G__62366 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__62363;
idx = G__62364;
start = G__62365;
out = G__62366;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__62303_SHARP_,p2__62302_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__62302_SHARP_)){
return cljs.core.reduced(p1__62303_SHARP_);
} else {
return (p1__62303_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__62305,p__62306){
var vec__62307 = p__62305;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62307,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62307,(1),null);
var vec__62310 = p__62306;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62310,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62310,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__62315,cvec,focus_vec){
...
var map__62317 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62316__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__62317__$1 = (((((!((map__62317 == null))))?(((((map__62317.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62317.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__62317):map__62317);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62317__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62317__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62317__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62314_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__62314_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
