...
var G__55301 = devtools.prefs.pref(v);
v = G__55301;
continue;
} else {
return v;
...
}catch (e55254){var _e__40465__auto__ = e55254;
return false;
}})();
...
}catch (e55259){var _e__40465__auto__ = e55259;
return false;
}})();
...
}catch (e55261){var _e__40465__auto__ = e55261;
return false;
}}
}
});
...
var vec__55281 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55281,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55281,(1),null);
...
return cljs.core.some((function (p1__55290_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__55290_SHARP_);
}),template);
});
