...
return [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(0),(function (){var G__64457 = per_side_budget;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64453__$1)].join('')));
...
var G__64527 = clojure.string.replace(s,match,trunc_prefix);
var G__64528 = limit;
var G__64529 = match;
var G__64530 = trunc_prefix;
s = G__64527;
limit = G__64528;
match = G__64529;
trunc_prefix = G__64530;
continue;
}
}
break;
...
var prefix = (function (){var G__64463 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [G__64463,"\u2026/"].join('');
} else {
return G__64463;
}
})();
...
var vec__64481 = day8.re_frame_10x.utils.pretty_print_condensed.edges(coll);
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64481,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64481,(1),null);
...
var or__4185__auto__ = (function (){var G__64490 = form.name;
if((G__64490 == null)){
return null;
} else {
return clojure.string.replace(G__64490,/(^.*\$)(.*)/,"$2");
}
})();
...
var G__64497 = obj;
var G__64498 = writer;
var G__64499 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(opts,new cljs.core.Keyword(null,"fallback-impl","fallback-impl",-1501286995),day8.re_frame_10x.utils.pretty_print_condensed.pr_writer_impl);
return (alt_impl.cljs$core$IFn$_invoke$arity$3 ? alt_impl.cljs$core$IFn$_invoke$arity$3(G__64497,G__64498,G__64499) : alt_impl.call(null,G__64497,G__64498,G__64499));
} else {
...
var seq__64501 = cljs.core.seq(cljs.core.next(objs));
var chunk__64502 = null;
var count__64503 = (0);
var i__64504 = (0);
while(true){
if((i__64504 < count__64503)){
var obj = chunk__64502.cljs$core$IIndexed$_nth$arity$2(null,i__64504);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__64552 = seq__64501;
var G__64553 = chunk__64502;
var G__64554 = count__64503;
var G__64555 = (i__64504 + (1));
seq__64501 = G__64552;
chunk__64502 = G__64553;
count__64503 = G__64554;
i__64504 = G__64555;
continue;
} else {
...
var G__64556 = cljs.core.chunk_rest(seq__64501__$1);
var G__64557 = c__4609__auto__;
var G__64558 = cljs.core.count(c__4609__auto__);
var G__64559 = (0);
seq__64501 = G__64556;
chunk__64502 = G__64557;
count__64503 = G__64558;
i__64504 = G__64559;
continue;
} else {
var obj = cljs.core.first(seq__64501__$1);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__64564 = cljs.core.next(seq__64501__$1);
var G__64565 = null;
var G__64566 = (0);
var G__64567 = (0);
seq__64501 = G__64564;
chunk__64502 = G__64565;
count__64503 = G__64566;
i__64504 = G__64567;
continue;
}
} else {
...
var len__4789__auto___64570 = arguments.length;
var i__4790__auto___64571 = (0);
while(true){
if((i__4790__auto___64571 < len__4789__auto___64570)){
args__4795__auto__.push((arguments[i__4790__auto___64571]));

var G__64572 = (i__4790__auto___64571 + (1));
i__4790__auto___64571 = G__64572;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.utils.pretty_print_condensed.pr_str_truncated.cljs$lang$applyTo = (function (seq64517){
var G__64518 = cljs.core.first(seq64517);
var seq64517__$1 = cljs.core.next(seq64517);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64518,seq64517__$1);
}));
